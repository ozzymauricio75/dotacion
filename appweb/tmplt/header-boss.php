...
$headerTakeOrder .= "<div class=' maxwidth-layout'>";
        
            //<!-- Logo -->
$headerTakeOrder .= "<a href='".$pathmm.$bossDir."/inicio/' class='logo'>      
...
if(isset($actiSecc) && $actiSecc == "catalogo"){
$headerTakeOrder .= "<li>";
$headerTakeOrder .= "<a href='".$pathmm."boss/inicio/' class='pzskit' name='' title='Advertencia' data-msj='Perderás el pedido que estas realizando, tendrás que iniciar uno nuevo. Estas seguro que deseas continuar?'>
                        <i class='fa fa-trash margin-right-xs'></i>
                        Cancelar orden
                    </a>";
$headerTakeOrder .= "</li>";     
$headerTakeOrder .= "<li><a href='#' data-toggle='control-sidebar'>
                        <i class='fa fa-shopping-cart'></i>                     
                    </a></li>";
}else{

$headerTakeOrder .= "<li>";
$headerTakeOrder .= "<a href='".$pathmm."boss/inicio/?orderboss=new'>
                        <i class='fa fa-th-large margin-right-xs'></i>
                        Dotaci&oacute;n
                    </a>";
$headerTakeOrder .= "</li>"; 
...
$headerTakeOrder .= "<li class='dropdown user user-menu' style='border-right:1px solid #eee;'>
                    <a href='#' class='dropdown-toggle' data-toggle='dropdown'>
                    ...
                    <ul class='dropdown-menu'>
                      ...
                      <li class='user-footer'>
                        ...
                        <div class='text-center'>
                          <a href='".$pathmm.$bossDir."/logout/' class='btn btn-default btn-flat'>Salir</a>
                        </div>
                      </li>
                    </ul>
                  </li>";
