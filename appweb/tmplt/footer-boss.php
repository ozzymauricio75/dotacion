...
$footerTakeOrder .="<div class='col-xs-12 col-sm-3 smabout'>
                    ...
                    <p><i class='fa fa-quote-left fa-3x padd-right-xs'></i>Somos una de las principales compa&ntilde;&iacute;as de moda en Colombia y contamos con un reconocido prestigio nacional, pues gracias a su vertiginoso crecimiento y posicionamiento comercial, la capacidad operativa y generación de empleo ha contribuido al desarrollo econ&oacute;mico de la industria textil en los últimos a&ntilde;os. </p>
                </div><!--//SOBRE-->";
...
$footerTakeOrder .="<div class='col-xs-12 col-sm-3 smcata'>                    
                    ...
                    <p><a href='".$pathmm.$bossDir."/sitemap/' type='button'>Ver mapa del sitio</a></p>";
...
$footerTakeOrder .="<div class='col-xs-12 col-sm-3 smcto'>                    
                    ...
                    <p><a href='#!' type='button' data-toggle='modal' data-target='#polidev'>Politicas de devoluci&oacute;n</a></p>
                    <p><a href='../userguia/' target='_black' type='button'>Gu&iacute;a de usuario</a></p>
...
$footerTakeOrder .="<div class='col-xs-12 col-sm-3 smcopy'>
                    ...
                    <p>Raz&oacute;n Social: QUEST S.A.S.</p>
                    <p>Nit: 805022296-8</p>
...
$footerTakeOrder .="<div class='row wrapactualizacion maxwidth-layout'>
                <div class='col-xs-12'>
                    <p style='text-align:center;'>La &uacute;ltima actualizaci&oacute;n del aplicativo fue: Enero 11 de 2017 / 23:35</p>                    
                </div>
            </div><!--//ACTUALIZACION-->";
