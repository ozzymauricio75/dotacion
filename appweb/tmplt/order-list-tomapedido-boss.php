...
$pedido = queryOrderTmpOne($otNOW);  
    ...
    //<!-- Control Sidebar -->
    $listOrder ="<aside class='control-sidebar control-sidebar-light ' id='tolsidebar'>";//control-sidebar-open
    ...
    $listOrder .="<div class='btn-group btn-group-sm pull-right' role='group' aria-label='...'>
                <a href='".$pathmm.$bossDir."/browse/?ordersend=ok&ordernow=".$idOrderNow."' type='button' class='btn'><i class='fa fa-check'></i> Enviar</a>";    
