$(document).ready(function(){ 
    ...
    $("#addprodorder").click(function(){
        ...
        var prod_var = $("#kitq").val();
        var pieza_var = $("#prendaq").val();
        var prenda_type_var = $("#tipoprendaq").val();
        var cant_var = $("#cantcart").val();
        var color_var = $("#colorq").val();                
        var talla_var = $("#tallaq").val();                        
        

        var dataString = "pedido_data="+pedido_var+"&prod_data="+prod_var+"&cant_data="+cant_var+"&color_data="+color_var+"&talla_data="+talla_var+"&prenda_data="+pieza_var+"&tipoprenda_data="+prenda_type_var+"&fieldedit=addpot"; 
        //alert(dataString);
            ...
            success: function(data) {                    
                ...
                if (response["error"]) {
                    ...
                    $("#wrapaddpot"+" .loader").fadeOut(function(){
                        ...
                        $("#err"+datafield).append("<div class='alert alert-success box25' role='alert'><i class='fa fa-check fa-lg margin-right-xs'></i> Selecciona otra categoría del catálago y continuar comprando</div>").fadeIn("slow");
    ...
    $('input.cpe').each(function(){
       ...
       $(this).blur(function(){
            ...
            //data-field='cplto' data-post='".$idProdItem."' data-order='".$idOrderTmpItem."' data-precio='".$costoProdItem."' data-unit='".$precioVentaItem."'
                ...
                var dataString = 'editlpto=ok&value='+$(this).val()+'&field='+$(this).attr('name')+'&post='+$(this).attr('data-post')+'&fieldedit='+$(this).attr('data-field');
