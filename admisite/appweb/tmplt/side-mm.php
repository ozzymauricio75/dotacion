          ...
          <ul class="treeview-menu">
            <li class="'.$custom_feactures_prod.'">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="'.$custom_sublevel_feacturesprod.'"><a href="'.$pathmm.$admiDir.'/custom/prods/features/"><i class="fa fa-chevron-circle-right"></i> Especificaciones</a></li>
                    <li class="'.$custom_sublevel_levelsprod.'"><a href="'.$pathmm.$admiDir.'/custom/prods/levels/"><i class="fa fa-chevron-circle-right"></i> Categor&iacute;as</a></li>
                </ul>
            </li>
                                    
            <li class="'.$custom_account.'"><a href="'.$pathmm.$admiDir.'/custom/account/"><i class="fa fa-chevron-circle-right"></i> Cuenta</a></li>
          </ul>
        </li>';
        
$tmplSideAS .= '<li class="treeview '.$empresa_root.'">
          <a href="'.$pathmm.$admiDir.'/manual/" target="_blank">
