...
$tmplHeadAS .= '<a href="" class="logo">
        ...
        <span class="logo-mini"><b>Quest</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Quest</b>ADMIN</span>
    </a>';
//*
//NAVBAR    
//*
...
//*
$tmplHeadAS .= '<a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
...
$tmplHeadAS .= '<li class="user-header">
                <img src="'.$pathmm."files-display/manager/".$imgSSUser.'" class="img-circle  bg-white" alt="">
...
$tmplHeadAS .= '<li class="user-footer">
                <div class="pull-left">
                  <a href="'.$pathmm.$admiDir.'/custom/account/" class="btn btn-default btn-flat">Mi cuenta</a>
                </div>
