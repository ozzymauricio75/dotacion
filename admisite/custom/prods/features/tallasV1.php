        ...
        <section class="content ">
            <div class="row">
                <div class="col-xs-12">
                    <ul class="nav nav-tabs">
                        <li role="presentation" class="active"><a href="#">Colores</a></li>
                        <li role="presentation"><a href="#">Tallas</a></li>
                        <li role="presentation"><a href="#">Tipo de prendas</a></li>
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Empresas publicadas</h3>
                </div>                
                <div class="box-body ">
                    <table id="printdatatbl" class="table table-bordered table-striped">
                        ...
                        if(is_array($dataQueryTbl)){
                            foreach($dataQueryTbl as $dqKey){
                                //id_account_empre, ref_account_empre, nombre_account_empre, nit_empresa, logo_account_empre, mail_account_empre, tel_account_empre1, tel_account_empre2, dir_account_empre, ciudad_account_empre, fecha_alta_empresa
                                                                
                                $idItem = $dqKey['id_account_empre'];
                                $nameItem = $dqKey['nombre_account_empre'];
                                $nitItem = $dqKey['nit_empresa'];
                                $mailItem = $dqKey['mail_account_empre'];
                                $telItem = $dqKey['tel_account_empre1'];
                                $tel2Item = $dqKey['tel_account_empre2'];
                                $dirItem = $dqKey['dir_account_empre'];
                                $ciudadItem = $dqKey['ciudad_account_empre'];
                                $dataAltaItem = $dqKey['fecha_alta_empresa'];
                                $statusItem = $dqKey['id_estado'];
                                
                                $repreItem = $dqKey['nome_representante'];
                                ...
                                $layoutDataItem .= "<p>";
                                $layoutDataItem .= "<strong>".$repreItem."</strong>"; 
                                $layoutDataItem .= "</p>";
