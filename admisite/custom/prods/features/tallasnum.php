...
if(isset($_GET['trash']) && $_GET['trash'] == "ok"){ 
    ...
    if(isset($_GET['coditemrefget'])){
        ...
        //ELIMINAR ITEM
        $fieldItemTBL = "id_talla_numer";  
        $tblItemTBL = "talla_numerico";
...
//COLORES
$dataQueryTbl = array();
$dataQueryTbl =  queryTallasNume();

$layoutQuery = "";
if(is_array($dataQueryTbl)){
    foreach($dataQueryTbl as $dqKey){
        $idTalla = $dqKey['id_talla_numer'];
        $nameTalla = $dqKey['talla_numer'];
        $posiTalla = $dqKey['posi_talla'];
        
        $layoutQuery .= "<div class='col-xs-4 col-sm-2 margin-bottom-xs'>";                
        $layoutQuery .= "<a href='".$pathmm.$admiDir."/custom/prods/features/tallasnum.php?trash=ok&coditemrefget=".$idTalla."' class='cancelOrder trashtobtn' name='".$nameTalla."' title='Eliminar Talla' data-msj='Estas seguro que deseas eliminar esta talla?'><i class='fa fa-trash fa-lg'></i></a>";
    ...
    <div class="content-wrapper">
        ...
        */
        ...
        <section class="content-header bg-content-header">
            ...
            <h1><small>Especificaciones productos / Tallas / </small> Tallas números</h1>
                    ...
                    <div class="row unlateralmargin">
                        <div class="col-xs-12 col-sm-2 unlateralpadding">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li role="presentation" class="active"><a href="<?php echo $pathmm.$admiDir."/custom/prods/features/tallasnum.php"; ?>">Tallas números</a></li>
    ...
    <aside class="control-sidebar control-sidebar-light" style="max-height: calc(100% - 50px); overflow-y: auto; margin-bottom:2%;">        
        ...
        <div class="box100 "  >
            ...
            <div class="row wrapdivsection"><!---color--->   
                <div class="col-xs-12 ">
                    <h4>Publicar talla números</h4>                                                            
                    <div class="form-group">                        
                        <label>Nombre</label>
                        <input type="text" name="nametallanum" class="form-control" placeholder="Nombre talla" />
                    </div>                                       
                </div>  
            ...
            <section class="bottonnav bottomtools" style="position:fixed; top:auto; bottom:0px; z-index:999; width:100%;"><!---/main-footer navbar-fixed-bottom-->
                ...
                <nav class="">
                    ...
                    <div id="right-bartbtn" class="nav navbar-nav navbar-left padd-verti-xs">                        
                        <button type="button" class="btn btn-info margin-hori-xs " id="additembtn" data-field="tallanumadd">
