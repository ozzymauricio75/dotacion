...
function printListOrder($idOrderTmp_){
    ...
    foreach($prodList as $iplotemKey){
        ...
        $prodListTmpl .="<td>".$SKUProdItem."</td>";
        $prodListTmpl .="<td>Calido Formal</td>";
        $prodListTmpl .="<td>".$descriRefProdItem."</td>";
        $prodListTmpl .="</tr>";
...
$tmplatesend='
    ...
    <td width="200px"><strong>'.$nameCity.'&nbsp;-&nbsp;'.$estateCity.'</strong></td>
    </tr>
    <!----<tr>
    ...
    <td width="200px"><strong>'.$nameBeneSend.'</strong></td>    
    </tr>
    <tr>
    <td width="150px">N.I.T</td>
    <td width="500px"><strong>'.$nitCompanySend.'</strong></td>
    
    <td width="150px">Cedula:</td>
    <td width="200px"><strong>'.$deculaBeneSend.'</strong></td>
    </tr>
    ...
    <td width="200px"><strong>'.$telBeneSend.'</strong></td>    
    </tr>
    <tr>
    ...
    <td width="150px">Email:</td>
    <td width="200px"><strong>'.$mailBeneSend.'</strong></td>
    </tr>
    ...
    <td width="200px"><strong>'.$dirBeneSend.'</strong></td>    
    </tr>
    ...
    <td width="150px">Ciudad:</td>
    <td width="200px"><strong>'.$cityBeneSend.'</strong></td>
    </tr>
    <tr><td style="padding-bottom:24px;" colspan="2"></td></tr>
    </tbody>
    </table>
...
function mailSendOrder($emailSSUser_, $tmplatesend_){
	...
	$headers .= "From: Dotaciones QUEST <licitaciones@quest.com.co>\r\n"; //"From: Dotaciones QUEST <ozzymauricio75@gmail.com>\r\n";//"From: Dotaciones QUEST <licitaciones@quest.com.co>\r\n";
	...
	//$headers .= "Cc: ozzymauricio75@gmail.com\r\n"; 
