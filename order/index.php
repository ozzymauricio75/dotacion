...
<body class="bgdark">
<?php require_once '../appweb/inc/logintakeorder.php'; ?>    
    <div class="container-fluid wraplogin" >
        <div class="box25 padd-verti-md text-center">
            ...
            <span class="cbp-ig-title">Catálogo Dotaciones</span><br>
            <small><b>Nit. 805022296-8</b></small>
            ...
            <form action="<?php echo $pathFile; ?>/" method="post" id="to_loginform"> 
                ...
                <div class="form-group">                    
                    <div class="input-group input-group-lg">
                        ...
                        <input type="password" class="form-control" name="passuser" aria-describedby="passinput" placeholder="Contraseña">
                    </div>
                </div>                                
