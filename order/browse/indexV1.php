                            ...
                            <div class="col-xs-6">
                                <?php
                                    if(isset($printLev3Acti_nome)){
                                        echo "<h2 class='no-padmarg text-center hidden-xs'><small class='margin-right-xs'>Estas escojiendo tu </small>".$printLev3Acti_nome."</h2>";                                        
                                    }else{
                                        echo "<h4 class='text-center hidden-xs'>Hola, para este KIT podes seleccionar las siguientes piezas </h4>";
                                    }
                                ?>
                    ...
                    <div class="row maxwidth-layout padd-verti-md">
                        ...
                        foreach($printProds as $prodKey ){ //as $valprods
                            ...
                            */
                            ...
                            $pathPortada = "../../files-display/tienda/img500/$prodFile";  
                                ...
                                if($totalFiles>0){                                                          
                                     ...
                                     if($printRefAlbum == $refAlbumProd){                     
                                        ...
                                        foreach($printFotos as $itemF){
                                            $printItemFotos = $pathmm."files-display/album/500/".$itemF;

                                            $galeryTmpl .= "<div>";
                                            $galeryTmpl .= "<img src='".$printItemFotos."' class='img-responsive' />";
                                            $galeryTmpl .= "</div>";
                                        }    
                                        $galeryTmpl .= "</div>";   
                                        echo $galeryTmpl;
