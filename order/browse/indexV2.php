...
<body class="hold-transition skin-black layout-top-nav " >
            ...
            <section class="content bg-gray-light padd-top-md padd-bottom-lg" > 
                ...
                */
                ...
                <div class="migajassite row maxwidth-layout">
                    ...
                    <div class="col-xs-12 col-sm-2 wrapknob text-center" >
                        <?php 
                        ...
                        ?>                        
                        <div class="no-padmarg knob-label"><label>% Pedido completado</label></div>
                    </div>
                            ...
                            <div class="box box-default">                                
                                <div class="box-body">
                                    ...
                                    <form action="<?php echo $pathFile; ?>/" method="get">
                                        ...
                                        <?php
                                            echo $input_l2.$input_l3.$input_cate.$input_kit_explorar.$input_talla.$input_color.$input_genero_talla;//$input_talla.$input_color;//$input_sb.$input_brand
                                        ?>
                                        <!--</div>-->
                                    </form>
                                    <!--</div>-->
    ...
    <input type="hidden" name="namekit" id="namekit" value="<?php echo $namePKit; ?>">        
