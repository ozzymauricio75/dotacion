$(document).ready(function(){ 
    ...
    $(".addprodsr").click(function(){
        ...
        var namekit = $('#namekit').val();
        
        var namekitadd = $('#namekitadd').val();
        
        if(namekitadd == ""){
            
            var linkURL = actionform+'?l2='+tipokit+'&tagcat='+namekit+'&steps=cuatro';   
        }else{
            var linkURL = actionform+'?steps=cuatro&tagcatadd=adicional';
        }
